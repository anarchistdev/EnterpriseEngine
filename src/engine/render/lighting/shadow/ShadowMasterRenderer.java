...
public class ShadowMasterRenderer {
    ...
    private static ShadowFrameBuffer shadowFbo;
    ...
    private ShadowNodeRenderer entityRenderer;
    ...
    public ShadowMasterRenderer(Camera camera) {
        ...
        shadowBox = new ShadowBox(lightViewMatrix, camera, shadowOptions.getShadowDistance());
        shadowFbo = new ShadowFrameBuffer(shadowOptions.getShadowMapSize(), shadowOptions.getShadowMapSize());
        entityRenderer = new ShadowNodeRenderer(shader, projectionViewMatrix);
    }

    public void render(List<Node> dataList, Light sun) {
        shadowBox.update();
        Vector3f sunPosition = sun.getPosition();
        Vector3f lightDirection = new Vector3f(-sunPosition.x, -sunPosition.y, -sunPosition.z);
        prepare(lightDirection, shadowBox);
        entityRenderer.render(dataList);
        finish();
    }
     ...
     */
    public void calcToShadowMapSpaceMatrix() {
        shadowOptions.setShadowMatrix(Matrix4f.mul(offset, projectionViewMatrix, null));
    }
