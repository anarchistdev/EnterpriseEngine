...
public class ShadowBox {
    ...
    private float windowAspectRatio = (float) DisplayManager.getWindowWidth() / (float) DisplayManager.getWindowHeight();
     ...
     *            - the in-game camera.
     */
    protected ShadowBox(Matrix4f lightViewMatrix, Camera camera, float shadowDistance) {
...
//        farWidth = (float) (shadowDistance * Math.tan(Math.toRadians(MasterRenderer.getFOV())));
//        nearWidth = (float) (MasterRenderer.getNearPlane()
//                * Math.tan(Math.toRadians(MasterRenderer.getFOV())));
//        farHeight = farWidth / getAspectRatio();
//        nearHeight = nearWidth / getAspectRatio();
        farWidth = (float) (shadowDistance * Math.tan(Math.toRadians(MasterRenderer.FOV)));
        nearWidth = (float) (MasterRenderer.NEAR_PLANE * Math.tan(Math.toRadians(MasterRenderer.FOV)));
        farHeight = farWidth / windowAspectRatio;
        nearHeight = nearWidth / windowAspectRatio;
    }
